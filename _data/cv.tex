...
\begin{tabularx}{\linewidth}{@{} C @{}}
	...
	\href{https://kha-dinh.github.io}{\raisebox{-0.05\height}\faGlobe \ kha-dinh.github.io} \ $|$ \
...
I build practical and principled solutions at the intersection of operating systems and security.
My current research focuses on compartmentalization, side-channel mitigations, confidential computing, and policy compliance.
...
\begin{tabularx}{\linewidth}{@{}lX@{}}
	...
	\begin{minipage}[t]{\columnwidth}
		\begin{itemize}[nosep,after=\strut, leftmargin=2em, itemsep=3pt]
			...
			\item Synopsis: Argues that protections established by hardware and OS must be coherent to close protection gaps exploited by modern attackers.
...
\begin{itemize}[nosep,after=\strut, leftmargin=2em, itemsep=3pt]
	\item Investigated developers practices for translating C into Rust from real-world repositories
...
% \textsc{Optimizing AddressSanitizers for Rust}~\cite{rustsan}
% \begin{itemize}[nosep,after=\strut, leftmargin=2em, itemsep=3pt]
...
\begin{itemize}
	\item ESW4010: Special Topics on System Security (Fall 2021, Spring 2022, Fall 2022)
	      \begin{itemize}
		      ...
		      \item The framework was used to teach subsequent courses at \url{https://ctf.skku.edu/}.
	      \end{itemize}
